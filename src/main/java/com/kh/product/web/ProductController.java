...
public class ProductController {
    ...
    public String add(@Valid @ModelAttribute("form") AddForm addForm,
        ...
        if(addForm.getCount() > 100){
            bindingResult.rejectValue("count","maxCount","최대 갯수는 100을 초과할수 없습니다.");

            return "product/addForm";
        }
//        if(addForm.getCount() == 0 || addForm.getCount() < 0){
//            bindingResult.rejectValue("count","minCount","수량은 0과 음수는 입력할 수 없습니다.");
//
//            return "product/addForm";
//        }
//        if(addForm.getPrice() == 0 || addForm.getPrice() < 0){
//            bindingResult.rejectValue("price","minPrice","가격은 0과 음수는 입력할 수 없습니다.");
//
//            return "product/addForm";
//        }
        if(addForm.getCount() * addForm.getPrice() > 10_000_000){
            bindingResult.reject("totalChk","수량과 단가의 총액은 1000만원을 초과할 수 없습니다.");
...
//        if(editForm.getCount() == 0 || editForm.getCount() < 0){
//            bindingResult.rejectValue("count","minCount","수량은 0과 음수는 입력할 수 없습니다.");
//
//            return "product/editForm";
//        }
//        if(editForm.getPrice() == 0 || editForm.getPrice() < 0){
//            bindingResult.rejectValue("price","minPrice","가격은 0과 음수는 입력할 수 없습니다.");
//
//            return "product/editForm";
//        }
        if(editForm.getCount() * editForm.getPrice() > 10_000_000){
            bindingResult.reject("totalChk","수량과 단가의 총액은 1000만원을 초과할 수 없습니다.");
